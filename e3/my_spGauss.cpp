...
bool spGauss(int x)
{
	...
	ifstream EliminationFile("/home/data/Groebner/" + Folders[selection] + "/1.txt", std::ios::binary), ResultFile;
	EliminationFile.open("/home/data/Groebner/" + Folders[selection] + "/2.txt", std::ios::binary);
	...
	int **row = new int *[Elimination], **out = new int *[Elimination], *gotEliminator = new int[Elimination]{0};
